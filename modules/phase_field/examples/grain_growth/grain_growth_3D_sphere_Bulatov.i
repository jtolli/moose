...
[Mesh]
  ...
  nz = 8 # Number of elements in the z-direction
  xmin = 0 # minimum x-coordinate of the mesh
  xmax = 1000 # maximum x-coordinate of the mesh
  ymin = 0 # minimum y-coordinate of the mesh
  ymax = 1000 # maximum y-coordinate of the mesh
  zmin = 0 #minimum z-coordinate of the mesh
  zmax = 1000 # maximum z-coordinate of the mesh
...
[BCs]
  ...
  [./Periodic]
    [./top_bottom]
      auto_direction = 'x y z' # Makes problem periodic in the x and y directions
    [../]
  [../]
[]
...
[Materials]
  [./CuGrGr]
    # Material properties
    type = GBBulatovFit # Quantitative material properties for copper grain growth.  Dimensions are nm and ns
